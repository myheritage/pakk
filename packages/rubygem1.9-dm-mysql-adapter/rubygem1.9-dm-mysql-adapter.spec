#-------------------------------------------------------------------------------
# rubygem1.9-dm-mysql-adapter.spec
#-------------------------------------------------------------------------------

%global ruby_sitelib  %(ruby1.9 -rrbconfig -e "puts RbConfig::CONFIG['sitelibdir']")
%global ruby_sitearch %(ruby1.9 -rrbconfig -e "puts RbConfig::CONFIG['sitearchdir']")

%global gemname dm-mysql-adapter


#-----------------------------------------------------------------------------
# Main package
#-----------------------------------------------------------------------------
Name:           rubygem1.9-dm-mysql-adapter
Version:        1.2.0
Release:        1%{?dist}
...
License:        MIT
URL:            http://github.com/datamapper/dm-mysql-adapter
...
Requires:       rubygem1.9-do_mysql >= 0.10.6
...
pushd %{buildroot}%{ruby_sitelib}/gems/%{gemname}-%{version}
  rm -rf .gitignore Rakefile dm-mysql-adapter.gemspec spec tasks
popd
