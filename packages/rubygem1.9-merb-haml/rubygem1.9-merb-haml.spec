#-------------------------------------------------------------------------------
# rubygem1.9-merb-haml.spec
#-------------------------------------------------------------------------------

%global ruby_sitelib  %(ruby1.9 -rrbconfig -e "puts RbConfig::CONFIG['sitelibdir']")
%global ruby_sitearch %(ruby1.9 -rrbconfig -e "puts RbConfig::CONFIG['sitearchdir']")

%global gemname merb-haml


#-----------------------------------------------------------------------------
# Main package
#-----------------------------------------------------------------------------
Name:           rubygem1.9-merb-haml
Version:        1.1.3
Release:        2%{?dist}
Summary:        Merb haml
...
Requires:       ruby1.9
Requires:       rubygem1.9-haml >= 2.0.3
Requires:       rubygem1.9-merb-core >= %{version}

%description
A plugin for the Merb Web framework that provides HAML support.
...
%{ruby_sitelib}/gems/%{gemname}-%{version}/Generators
