#-------------------------------------------------------------------------------
# rubygem1.9-merb-param-protection.spec
#-------------------------------------------------------------------------------

%global ruby_sitelib  %(ruby1.9 -rrbconfig -e "puts RbConfig::CONFIG['sitelibdir']")
%global ruby_sitearch %(ruby1.9 -rrbconfig -e "puts RbConfig::CONFIG['sitearchdir']")

%global gemname merb-param-protection


#-----------------------------------------------------------------------------
# Main package
#-----------------------------------------------------------------------------
Name:           rubygem1.9-merb-param-protection
Version:        1.1.3
Release:        2%{?dist}
Summary:        Merb param-protection
...
%description
A plugin for the Merb Web framework that provides filter to the parameters
available within the controller.
